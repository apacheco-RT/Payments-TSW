  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-2">
        <button disabled={avS === "loading"} onClick={() => onRunAV(pn)}
          className={`flex items-center gap-2 px-3 py-2.5 rounded-[var(--ds-radius-lg)] border text-left transition-all focus:outline-hidden focus:ring-2 focus:ring-teal-400 disabled:opacity-50
            ${avS === "done" ? "border-teal-500/30 bg-teal-500/5" : "border-slate-700/60 bg-[var(--ds-color-surface-page)] hover:border-slate-600"}`}>
        ...
        <button disabled={kybS === "loading"} onClick={() => onRunKYB(pn)}
          className={`flex items-center gap-2 px-3 py-2.5 rounded-[var(--ds-radius-lg)] border text-left transition-all focus:outline-hidden focus:ring-2 focus:ring-teal-400 disabled:opacity-50
            ${kybS === "done" ? "border-teal-500/30 bg-teal-500/5" : "border-slate-700/60 bg-[var(--ds-color-surface-page)] hover:border-slate-600"}`}>
      ...
      {avS === "loading" && avSt.length > 0 && (
        <div className="rounded-[var(--ds-radius-lg)] border border-slate-700/60 bg-[var(--ds-color-surface-page)] px-3 py-2.5 mb-2">
