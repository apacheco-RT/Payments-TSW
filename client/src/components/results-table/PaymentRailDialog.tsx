      ...
      {txn && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
          ...
          <motion.div ref={dialogRef}
            ...
            className="bg-[var(--ds-color-surface-page)] border border-slate-700/50 rounded-[var(--ds-radius-3xl)] shadow-2xl w-full max-w-3xl my-auto">
            ...
            <div className="px-6 py-5 border-b border-[var(--ds-color-border-default)]">
              <div className="flex items-start justify-between gap-4">
                ...
                <button onClick={onClose} aria-label="Close dialog"
                  className="p-1.5 rounded-[var(--ds-radius-lg)] text-slate-400 hover:text-white hover:bg-white/8 transition-colors shrink-0 focus:outline-hidden focus:ring-2 focus:ring-teal-400">
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-[var(--ds-radius-xs)] border border-[var(--ds-color-border-default)] font-mono text-xs text-slate-300">{txn.cur} → EUR</span>
                </div>
                {showStablecoin && (
            ...
            <div className={`p-6 grid grid-cols-1 ${showStablecoin ? "md:grid-cols-2" : ""} gap-4`}>
              <button
                ...
                className={`relative rounded-[var(--ds-radius-xl)] border-2 p-5 text-left transition-all duration-200 focus:outline-hidden focus:ring-2 focus:ring-teal-400 ${selectedRail === "bank-wire"
                  ...
                  : "border-slate-700/50 bg-[var(--ds-color-surface-default)] hover:border-slate-600"
                  }`}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2.5 rounded-[var(--ds-radius-lg)] bg-slate-800/60 border border-[var(--ds-color-border-default)]">
            ...
            {quoteGenerated && selectedRail === "stablecoin" && (
              <div className="px-6 pb-4 space-y-4">
                <div className="rounded-[var(--ds-radius-xl)] border-2 border-teal-500/40 bg-teal-500/5 p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2 py-0.5 rounded-[var(--ds-radius-xs)] border border-[var(--ds-color-border-default)] font-mono text-xs text-slate-300">quo_3f2a8c19b4e047d8</span>
                    </div>
                  </div>
                  <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 mb-4">
                    <div className="rounded-[var(--ds-radius-lg)] border border-slate-700/50 bg-[var(--ds-color-surface-default)] p-3">
                ...
                <div className="rounded-[var(--ds-radius-xl)] border border-slate-700/50 bg-[var(--ds-color-surface-default)] p-5">
