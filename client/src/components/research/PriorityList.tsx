...
export function PriorityList() {
  ...
  return (
    <section className="py-12 border-t border-slate-800/50 bg-[var(--ds-color-surface-sunken)]">
          ...
          <div className="space-y-3">
            {priority.map((p, i) => (
              <motion.div
                ...
                className="flex items-center gap-4 bg-[var(--ds-color-surface-default)] rounded-[var(--ds-radius-xl)] border border-slate-800 px-5 py-4 hover:border-slate-700 transition-colors"
              >
                <div className="w-12 h-12 rounded-[var(--ds-radius-xl)] bg-[var(--ds-color-surface-default)] border border-slate-700 flex items-center justify-center shrink-0">
